...
<form action="mailm2.php" method="post" onsubmit="target_popup(this)">
<p>Hoeveel maanden wilt u reserveren?</p><br>
<input type="number" id = "x" name="x" min="2" max="12" style='width:4vw;height:3vw;font-size:2vw;' required >
