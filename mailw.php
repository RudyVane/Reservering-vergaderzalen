...
<form action="mailw2.php" method="post" onsubmit="target_popup(this)">
<p>Hoeveel weken wilt u reserveren?</p><br>
<input type="number" id = "x" name="tel" min="2" max = "52" style='width:4vw;height:3vw;font-size:2vw;' required >
