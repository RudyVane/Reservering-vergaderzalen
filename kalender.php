...
<div class = "overlay" style="position: absolute;top:10%;left:2%;">
...
$dat1 = $final;
$_SESSION['datum'] = $dat1; 
echo "<script type='text/javascript'> document.location = 'kalender.php'; </script>"; 
}
...
<div id="" style="overflow:scroll; width:100%; height:700px;">	
<?php
echo "<table>";
            echo "<tr>";
