...
$message = '<p>Reservering vergaderruimte, wekelijks, '.$week.' weken, vanaf:</p>';
...
RRULE:FREQ=WEEKLY;INTERVAL=1;COUNT=' . $week . '
...
$mail->AltBody = 'Wekelijks, '.$week.' weken, Vanaf '.$dat2.',  Begintijd '.$begin.',Eindtijd '.$eind.',Contactpersoon: '.$naam.',Email:  '.$email.',Telefoon:  '.$telf.',Kostenplaats:  '.$kpl.',Project:  '.$proj.',Opmerking:  '.$opm.',Aantal personen:  '.$pers.',Catering:  '.$cat;
